...
export const PrivacyPolicy = () => {
  return (
    <ScrollView style={{ flex: 1 }}>
      ...
      <Text style={styles.content}>
        1. 수집 항목:{'\n'} • 필수 항목: 소속 대학, 대학 웹메일, 이름, 생년월일, 성별, 비밀번호{'\n'} • 자동수집:
        위치정보(GPS), IP 주소, 기기 정보(OS 버전, User‑Agent), 서비스 이용 기록(접속 시간, 클릭 로그), 쿠키·트래킹 정보
        {'\n'}2. 수집 방법:{'\n'} • 회원가입, 서비스 이용, 고객문의 시 수집{'\n'} • SDK·API 자동 수집{'\n'} • 위치정보는
        “앱 사용 중” 동의 후 수집{'\n'}3. 광고·추적 비사용:{'\n'} • 회사는 광고 목적이나 제3자 추적을 위해 어떠한
        개인정보도 사용·제공하지 않습니다.{'\n'} • 단, 신고 처리 시 신고자·피신고자의 이메일 및 게시글/채팅 내역은 국외
        서버로 전송되며, 6개월 간 보관될 수 있습니다.
      </Text>
      ...
      <Text style={styles.content}>
        1. 회사는 원칙적으로 개인정보를 외부에 제공하지 않으나, 아래 경우에 한해 제공합니다:{'\n'} • 이용자 동의 시
        {'\n'} • 법령에 따른 요청 시{'\n'} • 업무 위탁 수탁사 제공 시(‘위탁처리업체 목록’ 공지){'\n'} • 이용자 신고 발생
        시{'\n'} • 서비스 제공을 위한 필수적 경우{'\n'}2. 국외 이전 안내 {'\n'} • 회사는 신고 처리 시 신고자·피신고자
        이메일 및 게시글/채팅 내역을 국외 서버로 전송, 6개월 간 보관할 수 있습니다. {'\n'} • 이전 국가·수탁자, 이전
        목적·보유 기간, 정보주체 권리·구제 절차를 별도 공지합니다.
      </Text>
